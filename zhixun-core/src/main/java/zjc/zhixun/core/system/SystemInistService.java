package zjc.zhixun.core.system;

import zjc.zhixun.core.util.SystemInfoPrinter;
import zjc.zhixun.db.service.ZhiXunSystemConfigService;
...
class SystemInistService {
    ...
    @Autowired
    private ZhiXunSystemConfigService litemallSystemConfigService;
    ...
    private Map<String, String> getSystemInfo() {
        ...
        infos.put("调试级别", environment.getProperty("logging.level.zjc.zhixun.wx"));
