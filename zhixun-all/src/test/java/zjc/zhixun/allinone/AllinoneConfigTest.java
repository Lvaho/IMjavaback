...
//        System.out.println(environment.getProperty(""));
        ...
        System.out.println(environment.getProperty("logging.level.zjc.zhixun.wx"));
        System.out.println(environment.getProperty("logging.level.zjc.zhixun.admin"));
        System.out.println(environment.getProperty("logging.level.zjc.zhixun"));
    }
