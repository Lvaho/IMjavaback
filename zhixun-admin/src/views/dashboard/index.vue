<template>
  <div class="dashboard-editor-container">
    <div align="centen"><h1 align="center">欢迎来到之讯管理后台</h1> </div>
      ...
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel" @click="handleSetLineChartData('messages')">
          ...
          <div class="card-panel-description">
            ...
            <count-to :start-val="0" :end-val="messagesTotal" :duration="3000" class="card-panel-num"/>
          </div>
        </div>
      </el-col>
    </el-row>
...
export default {
  ...
  created() {
    info().then(response => {
      ...
      this.messagesTotal = response.data.data.goodsTotal
    })
  },
  methods: {
